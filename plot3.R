...
## ## HERE ARE THE INSTRUCTIONS FOR PLOT #3:
...
# Here is the legend.
# Found out that "cex" allows you to change the size of the legend in the plot.

legend("topright", lty=1, legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col=c("black", "red", "blue"), y.intersp=.5, cex=.9)
